  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-lg flex-col pb-20">
      <header className="flex items-center gap-2 border-b border-white/8 px-4 py-3">
        <span className="text-sm font-semibold">Datatek Pass</span>
      </header>
      {vehicleRail ? (
        <div className="sticky top-0 z-20 border-b border-white/8 bg-[var(--color-ink-950)]/95 px-4 py-2 backdrop-blur">
          <VehicleContextRail
