...
export * from "./src/commands/market-request-commands.ts";
...
// página cliente arrastraría `node:crypto`. Los módulos puros de
// observabilidad (logger/health/metrics) sí están en "@datatek/application".
export * from "./src/observability/command-observability.ts";
