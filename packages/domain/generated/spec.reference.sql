...
-- DO $$ BEGIN
--   -- valores permitidos: 'organization.read', 'organization.manage', 'branch.manage', 'membership.read', 'membership.manage', 'role.assign', 'catalog.read', 'catalog.manage', 'audit.read_organization', 'crm.read', 'crm.manage', 'vehicle.read', 'vehicle.manage', 'intake.read', 'intake.manage', 'agenda.read', 'agenda.manage', 'inspection.read', 'inspection.publish', 'quote.read', 'quote.manage', 'authorization.request', 'authorization.decide', 'work.read', 'work.manage', 'quality.manage', 'finance.read', 'finance.manage'
-- END $$;
...
--   owner: organization.read, organization.manage, branch.manage, membership.read, membership.manage, role.assign, catalog.read, catalog.manage, audit.read_organization, crm.read, crm.manage, vehicle.read, vehicle.manage, intake.read, intake.manage, agenda.read, agenda.manage, inspection.read, inspection.publish, quote.read, quote.manage, authorization.request, authorization.decide, work.read, work.manage, quality.manage, finance.read, finance.manage
--   advisor: organization.read, membership.read, catalog.read, crm.read, crm.manage, vehicle.read, vehicle.manage, intake.read, intake.manage, agenda.read, agenda.manage, inspection.read, quote.read, quote.manage, authorization.request, work.read
--   inspector: organization.read, catalog.read, vehicle.read, inspection.read, inspection.publish, work.read
--   mechanic: organization.read, catalog.read, vehicle.read, work.read, work.manage
--   cashier: organization.read, catalog.read, finance.read, finance.manage
--   customer: crm.read
